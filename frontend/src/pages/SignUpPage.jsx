...
function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-center px-6 sm:px-12 md:px-16 lg:px-24 py-8 sm:py-12 relative overflow-hidden">
        ...
        <div className="absolute -bottom-24 -right-24 w-72 h-72 sm:w-96 sm:h-96 bg-purple-50 rounded-full blur-3xl opacity-40 pointer-events-none" />
        ...
        <div className="w-full max-w-[540px] mx-auto relative z-10">
          ...
          <div className="mb-8 sm:mb-10 text-left">
            ...
            <p className="text-slate-500 text-base sm:text-lg lg:text-xl font-medium">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <label className="text-xs sm:text-sm font-bold text-slate-800 ml-1 uppercase tracking-widest">Full Name</label>
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <label className="text-xs sm:text-sm font-bold text-slate-800 ml-1 uppercase tracking-widest">Email Address</label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-blue-600 transition-colors">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <label className="text-xs sm:text-sm font-bold text-slate-800 ml-1 uppercase tracking-widest">Password</label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-blue-600 transition-colors">
