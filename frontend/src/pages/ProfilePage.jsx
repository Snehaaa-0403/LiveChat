      ...
      <div className="max-w-2xl mx-auto p-4 py-8">
        ...
        <div className="bg-white rounded-3xl p-8 space-y-8 shadow-xl border border-slate-100">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-slate-500 font-medium">Your personal information</p>
          </div>
            ...
            <div className="relative group">
              ...
              >
                ...
                <input
                  ...
                  disabled={isUpdatingProfile} // Will enable later for upload functionality
                />
              </label>
            </div>
          ...
          {/* Account Status Footer (Optional but looks professional) */}
          <div className="pt-6 border-t border-slate-100">
             <div className="flex items-center justify-between">
                <span className="text-sm font-bold text-slate-400 uppercase tracking-wider">Account Status</span>
                <span className="text-sm font-bold text-green-500 bg-green-50 px-3 py-1 rounded-full">Active</span>
             </div>
          </div>
